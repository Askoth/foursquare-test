(function () {
  ...
  var getters = {
      oauthUrl: function oauthUrl (ref) {
          var clientId = ref.clientId;
          var redirectUri = ref.redirectUri;

          return ("https://foursquare.com/oauth2/authenticate\n                    ?client_id=" + clientId + "\n                    &response_type=code\n                    &redirect_uri=" + (encodeURIComponent(redirectUri))).replace(/\s/g, '')
      },
      tokenUrl: function tokenUrl(ref, ref$1) {
          var clientId = ref.clientId;
          var redirectUri = ref.redirectUri;
          var secretId = ref.secretId;
          var code = ref$1.code;

          return ("/token\n                    ?client_id=" + clientId + "\n                    &redirect_uri=" + (encodeURIComponent(redirectUri)) + "\n                    &code=" + code).replace(/\s/g, '')
      },
      hasCode: function hasCode (state, ref) {
          var code = ref.code;

          return code.length > 0
      },
      code: function code (ref) {
  ...
  var actions = {
      getToken: function getToken(ref) {
  ...
  var script = {
      computed: Object.assign({}, mapGetters('login', ['oauthUrl', 'hasCode']))
  ...
  var __vue_render__ = function() {
    ...
    return !_vm.hasCode
      ? _c("a", { attrs: { href: _vm.oauthUrl } }, [_vm._v("Sign in")])
      : _vm._e()
  };
  ...
  __vue_render__._withStripped = true;
    ...
    function __vue_normalize__(
      ...
      component.__file = "/Users/marcelo/Projects/foursquare-test/src/components/Login.vue";
  ...
  var script$1 = {
      ...
      computed: Object.assign({}, mapGetters('login', ['hasCode'])),
      mounted: function mounted() {
          // couldn't thin about a better place to add this
          if (this.hasCode) {
              this.getToken();
          }
      },
      methods: Object.assign({}, mapActions('login', ['getToken']))
  };
